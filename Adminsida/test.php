...
<body>
    <div class="forms"></div>
        ...
        <form method="POST" action="anvandarprofil.php">
            ...
            <input type="password" id="password" placeholder="Lösenord" maxlength="20">
        </form>
    </div>
    <div class="dropdown">
        ...
        <ul class="items">
            <li><input type="checkbox" />Spelbarhet </li>
            <li><input type="checkbox" />Rolighet</li>
            <li><input type="checkbox" />Matte & Fysik </li>
            <li><input type="checkbox" />Struktur på kod </li>
            <li><input type="checkbox" />Grafik </li>
            <li><input type="checkbox" />Stefan? </li>
